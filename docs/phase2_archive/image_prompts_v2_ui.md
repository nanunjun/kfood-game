...
```
premium mobile casual game background, a cozy Korean rooftop dining spot at golden hour, string lights, city skyline soft in the distance, small table, modern-casual mood, warm palette, soft depth blur, polished 2D illustration (NOT photo, NOT 3D), no people, no readable text, wide 16