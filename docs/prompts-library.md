...
> 버전: **v1.23 (2026-05-31, M1 후반 art sprint mini extra — game-designer motion-spec 후속 gap 2건 [hand_marinade 손바닥 marinade press anchor + corndog_batter_bowl 콘도그 batter dip 그릇 anchor] §5.14 신설, ADR-005 Stage 2A 양념재우기 / dip substitute mechanic 매핑 prerequisite) — supersedes v1.22**
